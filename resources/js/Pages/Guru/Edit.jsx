...
export default function Edit({ auth, guru }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        status: guru.status || 'Guru', // Field baru
    ...
    const [fotoPreview, setFotoPreview] = useState(guru.foto_url);
    ...
    const submit = (e) => {
        e.preventDefault();
        router.post(route('guru.update', guru.id), data);
    };

    return (
        <AuthenticatedLayout header="Edit Data Guru">
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-2 flex items-center space-x-6">
                                    <img src={fotoPreview} alt="Foto Guru" className="w-24 h-24 rounded-full object-cover" />
