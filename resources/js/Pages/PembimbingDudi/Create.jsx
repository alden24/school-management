...
export default function Create({ auth, dudis }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('pembimbing-dudi.store'));
    };

    return (
        <AuthenticatedLayout header="Tambah Pembimbing DUDI Baru">
            <Head title="Tambah Pembimbing DUDI" />
