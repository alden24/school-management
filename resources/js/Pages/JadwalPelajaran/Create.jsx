...
export default function Create({ auth, semesters, kelases, mataPelajarans, gurus }) {
    ...
    const timeSlots = ['07:00', '07:45', '08:30', '09:15', '10:20', '11:05', '12:20', '13:05', '13:50', '14:35'];

    const handleJamMulaiChange = (e) => {
        const newTime = e.target.value;
        setData('jam_mulai', newTime);
        if (newTime && !timeSlots.includes(newTime)) {
            setTimeError('Jam mulai tidak sesuai dengan slot waktu yang tersedia.');
        } else {
            setTimeError('');
        }
    };
    ...
    return (
        <AuthenticatedLayout header="Tambah Jadwal Pelajaran Baru">
            <Head title="Tambah Jadwal" />
            <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form onSubmit={submit} className="p-6 space-y-6">
                        <div>
                            <InputLabel htmlFor="semester_id" value="Semester (Hanya Semester Aktif)" />
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="time" id="jam_mulai" value={data.jam_mulai} onChange={handleJamMulaiChange} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required />
                            ...
                            <div>
                                ...
                                <input type="time" id="jam_selesai" value={data.jam_selesai} onChange={(e) => setData('jam_selesai', e.target.value)} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required />
